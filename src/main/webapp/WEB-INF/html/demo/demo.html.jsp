	...
	<div class="container">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="${pageContext.request.contextPath}/demo/demo.html">演示</a></li>
		...
		<div class="carousel slide" id="function-example" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="${pageContext.request.contextPath}/resources/image/function/fun01.jpg" alt="fun01">
				</div>
				<div class="item">
					<img src="${pageContext.request.contextPath}/resources/image/function/fun02.jpg" alt="fun02">
				</div>
				<div class="item">
					<img src="${pageContext.request.contextPath}/resources/image/function/fun03.jpg" alt="fun03">
				</div>
				<div class="item">
					<img src="${pageContext.request.contextPath}/resources/image/function/fun04.jpg" alt="fun05">
				</div>
				<div class="item">
					<img src="${pageContext.request.contextPath}/resources/image/function/fun05.jpg" alt="fun05">
				</div>
			</div>
