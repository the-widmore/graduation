    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
				...
				<li class="active"><a href="/easyvote/help/help.html">帮助</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="../../html/user/userLogin.html">登录</a></li>
                        <li class="divider"></li>
                        <li><a href="../../html/user/userSignIn.html">注册</a></li>
                    </ul>
                </li>
            </ul>
        </div>
