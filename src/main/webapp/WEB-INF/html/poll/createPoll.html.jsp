...
<body>
	...
	<div class="container content">
		<div class="jumbotron">
			...
			<h4>
				方式一: <small>使用我们或者用户共享的模版，编辑后进行使用。</small>
			</h4>

			<div class="progress-nav">
				<span style="font-size: 20px"><b>选择模版</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>编辑模版</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>预览发布</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>成功发起</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>结束</b></span>
			</div>

			<h4>
				方式二: <small>全部自定义，对于问题较少的很实用，你也可以制作可以共享的模版。</small>
			</h4>

			<div class="progress-nav">
				<span style="font-size: 20px"><b>定义问题</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>预览发布</b></span> <span> <i
					class="glyphicon glyphicon-arrow-right"></i>
				</span> <span style="font-size: 20px"><b>成功发起</b></span> <span> <i
		...
		<div class="row">
			<div class="col-md-6">
				<div class="page-header">
					<h3>
						选择方式 <small><a href="#" class="btn btn-sm btn-info">
								相关演示</a></small>
					</h3>
				</div>

				<form action="#" method="POST" class="form-inline">
					<label>后续操作方式</label> <select class="form-control">
						<option value="way1">方式一</option>
						<option value="way2">方式二</option>
					</select>
					<!-- <input type="submit" class="btn btn-primary" value="开始创建"> -->
					<a href="searchPollModel.html" class="btn btn-sm btn-primary">
						开始创建</a>
