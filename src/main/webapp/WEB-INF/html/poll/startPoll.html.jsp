	...
	<div class="container">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="${pageContext.request.contextPath}/poll/startPoll.html">问卷</a></li>
		...
		<div class="row">
			<div class="col-sm-8">
				<div class="jumbotron">
					...
					<p>
						<a href="${pageContext.request.contextPath}/poll/createPoll.html" role="button"
